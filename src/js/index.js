...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const texts = ['Student', 'Developer', 'Coder', 'Ethical Hacker', 'Security Researcher'];
    let textIndex = 0;
    let charIndex = 0;
...
function startAllProgressBars() {
    animateProgressBar('skillprogress1', 'skillrating1', 10);
    animateProgressBar('skillprogress2', 'skillrating2', 7);
    animateProgressBar('skillprogress3', 'skillrating3', 8);
    animateProgressBar('skillprogress4', 'skillrating4', 9);
    animateProgressBar('skillprogress5', 'skillrating5', 6);
    animateProgressBar('skillprogress6', 'skillrating6', 10);
    animateProgressBar('skillprogress7', 'skillrating7', 9);
    animateProgressBar('skillprogress8', 'skillrating8', 7);
    ...
    animateProgressBar('skillprogress12', 'skillrating12', 7);
